...
class Sensors:
    ...
    def setRGB(self):
        self.rgb_cam = self.blueprint_library.find("semsor.camera.rgb")
    ...
    def setSeg(self):
        self.seg_cam = self.blueprint_library.find(
            "semsor.camera.semantic_segmentation"
        )
    ...
    def setDepth(self):
        self.depth_cam = self.blueprint_library.find("semsor.camera.depth")
